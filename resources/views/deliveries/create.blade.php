...
<div class="page-header">
    <div>
        <h1 class="page-title"><i data-lucide="truck" style="width:22px;height:22px;vertical-align:middle;margin-top:-4px;margin-right:4px;"></i> Tambah Delivery</h1>
        <p class="page-subtitle">Tambah data pengiriman baru</p>
    </div>
...
<div class="form-card">
    ...
    <form action="{{ route('deliveries.store') }}" method="POST">
        ...
        <div style="display:flex;gap:10px;margin-top:8px;">
            <button type="submit" class="btn-primary-custom"><i data-lucide="save" style="width:15px;height:15px;margin-right:4px;"></i> Simpan Delivery</button>
