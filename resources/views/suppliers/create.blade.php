...
<div class="page-header">
    <div>
        <h1 class="page-title"><i data-lucide="plus-circle" style="width:22px;height:22px;vertical-align:middle;margin-top:-4px;margin-right:4px;"></i> Tambah Supplier</h1>
        <p class="page-subtitle">Tambah mitra supplier baru ke sistem</p>
    </div>
...
<div class="form-card">
    ...
    <form method="POST" action="{{ route('suppliers.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-input" value="{{ old('name') }}" placeholder="Masukkan nama PT / Toko Supplier" required>
        </div>
        <div class="form-group">
            <label class="form-label">No. Telepon</label>
            <input type="text" name="phone" class="form-input" value="{{ old('phone') }}" placeholder="08xxxxxxxxxx / (021)xxxxxx" required>
        </div>
        <div class="form-group">
            <label class="form-label">Email (Opsional)</label>
            <input type="email" name="email" class="form-input" value="{{ old('email') }}" placeholder="contoh@supplier.com">
        </div>
        <div class="form-group">
            <label class="form-label">Alamat Lengkap</label>
            <textarea name="address" class="form-input" rows="3" placeholder="Masukkan alamat lengkap supplier" required>{{ old('address') }}</textarea>
        </div>
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:16px; margin-bottom: 20px;">
            <div>
                ...
                <input type="text" name="latitude" id="latitude" class="form-input" value="{{ old('latitude') }}" placeholder="Pilih dari peta atau isi manual">
            </div>
            <div>
                <label class="form-label">Longitude</label>
                <input type="text" name="longitude" id="longitude" class="form-input" value="{{ old('longitude') }}" placeholder="Pilih dari peta atau isi manual">
            </div>
        </div>
        <div style="display:flex;gap:10px;margin-top:8px;">
            <button type="submit" class="btn-primary-custom"><i data-lucide="save" style="width:14px;height:14px;vertical-align:middle;margin-top:-2px;"></i> Simpan Supplier</button>
