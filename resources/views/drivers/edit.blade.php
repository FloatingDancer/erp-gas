...
<div class="page-header">
    <div>
        <h1 class="page-title"><i data-lucide="edit" style="width:22px;height:22px;vertical-align:middle;margin-top:-4px;margin-right:4px;"></i> Edit Driver</h1>
        <p class="page-subtitle">Perbarui data driver/kurir pengiriman</p>
    </div>
...
<div class="form-card">
    ...
    <form method="POST" action="{{ route('drivers.update', $driver->id) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone" class="form-input" value="{{ old('phone', $driver->phone) }}" required>
        </div>

        <div class="form-row">
            <div class="form-group">
                <label class="form-label">No. Polisi (Kendaraan)</label>
                <input type="text" name="license_plate" class="form-input" value="{{ old('license_plate', $driver->license_plate) }}" required>
            </div>
        ...
        <div style="margin-top: 24px; margin-bottom: 16px; border-top: 1px solid #e2e8f0; padding-top: 16px;">
            ...
            <p style="font-size: 11px; color: #64748b; margin-bottom: 12px;">Isi untuk membuatkan atau memperbarui akun masuk bagi driver ini</p>
        </div>

        <div class="form-row">
            <div class="form-group">
                <label class="form-label">Email Login</label>
                <input type="email" name="email" class="form-input" value="{{ old('email', $driver->user ? $driver->user->email : '') }}" placeholder="driver@email.com">
            </div>
        ...
        <div style="display:flex;gap:10px;margin-top:8px;">
            <button type="submit" class="btn-primary-custom"><i data-lucide="save" style="width:15px;height:15px;margin-right:4px;"></i> Update Driver</button>
